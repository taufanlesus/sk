...
# Assist
ki = LINE('ufc44f9787ea11fae462fa22b6c388932:aWF0OiAxNTYwNTMzMDY3ODUyCg==..QQAELTJ9YVlYPcw+rhCcsB5LV3A=')
...
ke = LINE('u5cdb0d384acd384e23b452a7a4453974:aWF0OiAxNTYwNTk1MTE2MTg3Cg==..TOPCoD7BPIJMgrJR9qvJpdFgX+k=')
ke.log("Auth Token : " + str(ke.authToken))
channelToken = line.getChannelResult()

ks = LINE('u2f833135327cc21543d40396f8f20d11:aWF0OiAxNTYwNjIyOTU4MDk4Cg==..Y1O6I4Rf7YCyvqIbAf+MmTtkEWQ=')
ks.log("Auth Token : " + str(ks.authToken))
channelToken = line.getChannelResult()

kt = LINE('ue02eccf91ef04860d5d900ff05418d7f:aWF0OiAxNTYwNjIzNDQ1MTUyCg==..Wb2yND9slSzH7KX16SiyvgIA1dw=')
kt.log("Auth Token : " + str(kt.authToken))
channelToken = line.getChannelResult()

k1 = LINE('u67520ad1160b163bdbbd851749277053:aWF0OiAxNTYwNjIzNzI2MTU2Cg==..g0ZNrsiP2TNN8LFRELGSpuW8pQw=')
k1.log("Auth Token : " + str(k1.authToken)) 
channelToken = line.getChannelResult()

k2 = LINE('uf0921bf0dae11de5a9404cc0a5c6ed34:aWF0OiAxNTYwNjI0MDc2OTAyCg==..RemcHeURuxfQ/NtIEiKRjIX5W9U=')
k2.log("Auth Token : " + str(k2.authToken))
channelToken = line.getChannelResult()

k3 = LINE('u9a1b3c506da990a871bbe10c63c24152:aWF0OiAxNTYwNjI0NTMwMTU4Cg==..DKIC80/TLP7xUSoUFC1ZKvnN6UY=')
k3.log("Auth Token : " + str(k3.authToken))
channelToken = line.getChannelResult()

g1 = LINE('u1d8c2ad0b7e13921fcf1362a6a4c323c:aWF0OiAxNTYwNTMyMDQ1OTMzCg==..dtKBnJ09m0/25wY2YLeh0VJ0MH0=')
g1.log("Auth Token : " + str(g1.authToken))
channelToken = line.getChannelResult()

g2 = LINE('ueb41245a5ab2712c3ffa0695e344e7ed:aWF0OiAxNTYwNTMyNDkwMzA1Cg==..DtckyohORCWttkpCVTb1gy3yAqk=')
...
creator = ["u72f941bd8fb30742d39e366cc354e811","u0f6df437fe3e32f07c4562308ac430a9","u135efc0e80bf25248983ab548bb6c010"]
admin=['u72f941bd8fb30742d39e366cc354e811']
owner=['u72f941bd8fb30742d39e366cc354e811']
staff=['u72f941bd8fb30742d39e366cc354e811']
Bots = Bots 
#==============================================================================#
protectantijs = []
protectqr = []
                  ...
                  if msg._from in admin:
                    ...
                    line.sendMessage(to, "Berhasil menonaktifkan check details contact")
                            ...
                            if msg.toType == 2:
                                ...
                                targets = []
                                for g in gs.members:
                                    targets.append(g1.mid)
                                targets.remove(mid)
                                if targets == []:
                                    line.sendText(msg.to,"kayak nya limit")
                                else:
                                    for target in targets:
